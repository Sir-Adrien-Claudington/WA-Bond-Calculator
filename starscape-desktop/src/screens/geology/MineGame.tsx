...
const MINE_SITES: MineSite[] = [
  ...
  { id: 'broken-hill', name: 'Broken Hill', lat: -31.95, lon: 141.47,
    minerals: ['galena', 'zinc', 'pyrite'], state: 'NSW',
  ...
  { id: 'newman', name: 'Mount Whaleback', lat: -23.35, lon: 119.73,
    minerals: ['hematite', 'magnetite', 'iron'], state: 'WA',
  ...
  { id: 'olympic-dam', name: 'Olympic Dam', lat: -30.44, lon: 136.87,
    minerals: ['copper', 'gold', 'graphite'], state: 'SA',
  ...
  { id: 'mount-lyell', name: 'Mount Lyell', lat: -42.10, lon: 145.73,
    minerals: ['pyrite', 'copper', 'crocoite'], state: 'TAS',
    desc: 'Over a century of copper extraction in the rugged West Coast wilderness of Tasmania.' },
  { id: 'anakie', name: 'Anakie Gemfields', lat: -23.55, lon: 147.74,
    minerals: ['corundum', 'beryl', 'sapphire'], state: 'QLD',
    desc: 'Central Queensland sapphire fields — the largest sapphire-bearing region in the southern hemisphere.' },
  { id: 'renison', name: 'Renison Bell', lat: -41.79, lon: 145.42,
    minerals: ['tin', 'ilmenite', 'crocoite'], state: 'TAS',
    desc: "Australia's largest tin mine, deep in Tasmania's mineral-rich West Coast Range." },
];
...
const ELEMENTS: Record<string, ElementInfo> = {
  ...
  Ti: { name: 'Titanium',   mass: 47.867,  color: '#b8bcc4' },
  Cr: { name: 'Chromium',   mass: 51.996,  color: '#7fb0a0' },
  ...
  Sn: { name: 'Tin',        mass: 118.710, color: '#9fa6ad' },
